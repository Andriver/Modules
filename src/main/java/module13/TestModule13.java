...
import module13.entities.*;
import module13.utils.FilesUtils;
...
public class TestModule13 {
    ...
    private static void testsTask2() {
        try {
            ...
            String fileName = String.format("src/main/java/module13/data/user-%d-post-%d-comments.json", user.getId(), lastUserPost.getId());
    ...
    public static User createTestUser() {
        ...
        user.setId(1);
        user.setName("Andriy");
        user.setUsername("Prudnik");
        user.setEmail("aprudnik@gmail.com");

        Address address = new Address();
        address.setCity("Dnipro");
        address.setGeo(new Geo("2222", "3333"));
